...
image::./images/devon4ng-pl/allure.JPG[500,400]
image::./images/devon4ng-pl/maven.JPG[500,400]
...
* devon4ng-pl/Jenkinsfile

image::./images/devon4ng-pl/devon4ng.JPG[800,700]
...
* Build the job
* As output of the build new Jenkins Pipline job "devon4ng_build_template" under Angular directory will be created and also new repository "devonfw/devon4ng" will be created in Gitlab.
