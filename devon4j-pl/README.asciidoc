...
* Build the job
* As output of the build new Jenkins Pipline job "Devon4j_build_template" under Angular directory will be created and also new repository "devon/devon4j" will be created in Gitlab.
